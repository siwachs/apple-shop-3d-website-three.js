  ...
  useGSAP(() => {
    gsap.to('#exploreVideo', {
      scrollTrigger: {
        ...
        toggleActions: 'play pause reverse restart', // On Enter, On Leave, Enter back, Leave back
        start: '-10% bottom', // Bottom of trigger is -10% top of viewport
      },
      onComplete: () => {
  ...
  return (
    <section className="h-full common-padding bg-zinc relative overflow-hidden">
      <div className="screen-max-width">
        ...
        <div className="flex-col flex-center overflow-hidden">
